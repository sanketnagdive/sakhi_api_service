...
COPY requirements-prod.txt ./main.py ./query_with_gptindex.py ./cloud_storage.py ./query_with_langchain.py ./io_processing.py ./translator.py ./database_functions.py ./query_with_tfidf.py ./Titles.csv script.sh  /root/
